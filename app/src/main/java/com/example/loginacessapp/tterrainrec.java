 ...
 * Use the {@link tterrainrec#newInstance} factory method to
...
public class tterrainrec extends Fragment {
    ...
    public static tterrainrec newInstance(String param1, String param2) {
        tterrainrec fragment = new tterrainrec();
